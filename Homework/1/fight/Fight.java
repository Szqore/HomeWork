...
public class Fight {
    public static void main(String[] args) {
        ...
        System.out.println("ВЯЧЕСЛАВ: Здравствуйте ,свами я телеведущий РОССИЯ 23! Меня зовут Вячеслав,Мы играем игру СуперТриперУльтраБитМегаФитфунтнагибатор3000 ,короче игра,теперь, ВЫБЕРИ БОЙЦА:");
