...
public class FileRepository {
    // Высокопроизводительные кэш-карты в оперативной памяти Java
    ...
    public static void loadDataFromDisk() {
        try {
            // Если файлов нет на диске, создаем их с дефолтными демо-данными
    ...
    public static synchronized void addTicketToDisk(String ticketId, String title, String type, int price, int quota) {
        ...
        ticketTypes.put(ticketId, ticketLine);
